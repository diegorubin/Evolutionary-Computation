...
porém foi possível concluir que após a 30ª geração, a população já estavam ficando constantes.
...
Após executar o programa, o resultado obtido são os valores, $x = 4, y = 4, z = 2, f(x,y,z) = 680$
