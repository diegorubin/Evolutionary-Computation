...
Foi utilizado para testes um gerador de entradas. Este gerador pode ser obtido no 
endereço <ENDERECO>.

No primeiro caso de testes, foi gerado um caso com 20 pontos a serem cobertos
pelas antenas. A tabela <NOME DA TABELA> exibe os testes realizados com esses dados.
